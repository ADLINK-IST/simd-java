...
public class OSPLDomainParticipantFactory extends org.omg.dds.domain.DomainParticipantFactory {
    /**
     * Create a new participant in the domain with ID 0 having default QoS
     * and no listener.
     *
     * @see #createParticipant(int)
     * @see #createParticipant(int, org.omg.dds.domain.DomainParticipantQos, org.omg.dds.domain.DomainParticipantListener, java.util.Collection)
     */
    @Override
     ...
     */
    @Override
    public DomainParticipant createParticipant(int domainId, DomainParticipantQos qos, DomainParticipantListener listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     */
    @Override
    public DomainParticipant createParticipant(int domainId, String qosLibraryName, String qosProfileName, DomainParticipantListener listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * {@link #setDefaultParticipantQos(org.omg.dds.domain.DomainParticipantQos)}, or else, if
