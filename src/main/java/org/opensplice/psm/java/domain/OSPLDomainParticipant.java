...
public class OSPLDomainParticipant implements DomainParticipant {
     ...
     * factory.
     *
     * @see #createPublisher(org.omg.dds.pub.PublisherQos, org.omg.dds.pub.PublisherListener, java.util.Collection)
     */
     ...
     * @see #createPublisher()
     */
    public Publisher createPublisher(PublisherQos qos, PublisherListener listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * @see #createPublisher(org.omg.dds.pub.PublisherQos, org.omg.dds.pub.PublisherListener, java.util.Collection)
     */
    public Publisher createPublisher(String qosLibraryName, String qosProfileName, PublisherListener listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * factory.
     *
     * @see #createSubscriber(org.omg.dds.sub.SubscriberQos, org.omg.dds.sub.SubscriberListener, java.util.Collection)
     */
     ...
     */
    public Subscriber createSubscriber(SubscriberQos qos, SubscriberListener listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * @see #createSubscriber(org.omg.dds.sub.SubscriberQos, org.omg.dds.sub.SubscriberListener, java.util.Collection)
     */
    public Subscriber createSubscriber(String qosLibraryName, String qosProfileName, SubscriberListener listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     *                  changes.
     */
    public <TYPE> Topic<TYPE> createTopic(String topicName, Class<TYPE> type, String qosLibraryName, String qosProfileName, TopicListener<TYPE> listener, Collection<Class<? extends Status<?>>> statuses) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * <p/>
     * Unlike {@link #findTopic(String, org.omg.dds.core.Duration)}, the operation searches
     ...
     * @param expressionParameters   Parameters to the filterExpression.
     */
    public <TYPE> MultiTopic<TYPE> createMultiTopic(String name, String typeName, String subscriptionExpression, List<String> expressionParameters) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * last successful call to {@link #setDefaultPublisherQos(org.omg.dds.pub.PublisherQos)},
     ...
     * {@link #setDefaultSubscriberQos(org.omg.dds.sub.SubscriberQos)}, or else, if the call
     ...
     * <p/>
     * The values retrieved will match the set of values specified on the
     * last successful call to {@link #setDefaultTopicQos(org.omg.dds.topic.TopicQos)}, or
     ...
     */
    public Collection<InstanceHandle> getDiscoveredParticipants(Collection<InstanceHandle> participantHandles) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     * {@link #ignoreParticipant(org.omg.dds.core.InstanceHandle)} operation.
     * <p/>
     * Use the operation {@link #getDiscoveredParticipants(java.util.Collection)} to
     ...
     *                                       not locally maintain the connectivity information.
     */
    public Collection<InstanceHandle> getDiscoveredTopics(Collection<InstanceHandle> topicHandles) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
